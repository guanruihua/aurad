...
const Section = ({ id, title, className, bgUrl }: any) => {
  return (
...
export default () => {
  React.useEffect(() => {
    ...
    function navigateSectionById(id: string | number) {
    ...
    document.querySelectorAll('nav a').forEach((a) => {
      a.addEventListener('click', (e) => {
        e.preventDefault()
        navigateSectionById(
          (e.currentTarget as any).getAttribute('href').slice(1),
        )
      })
    })
  ...
  return (
    <div className="app-container demo1-container">
